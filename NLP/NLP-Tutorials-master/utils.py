...
class DateData:
    def __init__(self, n):
        ...
        self.v2i = {v: i for i, v in enumerate(sorted(list(self.vocab)), start=1)}  # start=1表示下标以1开始
        self.v2i["<PAD>"] = PAD_ID
        self.vocab.add("<PAD>")
